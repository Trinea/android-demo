...
<strong>注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意</strong>：拉下代码后,需要将TrineaAndroidCommon做为公共库引入。  公共库添加方法：TrineaAndroidCommon代码导入IDE,右击需要引入TrineaAndroidCommon做为公共库的工程->properties->Android，在library中选择TrineaAndroidCommon即可。  
